...
var dropSequences = [
  { id: "team-A-ban-1", desc: "탱커밴(선공)" },
  { id: "team-B-ban-1", desc: "탱커밴(후공)" },
  { id: "team-A-pick-1", desc: "탱커픽(선공)" },
  { id: "team-B-pick-1", desc: "탱커픽(후공)" },
  { id: "team-B-ban-2", desc: "딜러밴1(후공)" },
  { id: "team-A-ban-2", desc: "딜러밴1(선공)" },
  { id: "team-A-ban-3", desc: "딜러밴2(선공)" },
  { id: "team-B-ban-3", desc: "딜러밴2(후공)" },
  { id: "team-B-ban-4", desc: "딜러밴3(후공)" },
  { id: "team-A-ban-4", desc: "딜러밴3(선공)" },
  { id: "team-B-pick-2", desc: "딜러픽1(후공)" },
  { id: "team-A-pick-2", desc: "딜러픽1(선공)" },
  { id: "team-A-pick-3", desc: "딜러픽2(선공)" },
  { id: "team-B-pick-3", desc: "딜러픽2(후공)" },
  { id: "team-B-pick-4", desc: "딜러픽3(후공)" },
  { id: "team-A-pick-4", desc: "딜러픽3(선공)" },
  { id: "team-B-pick-5", desc: "힐러밴(후공)" },
  { id: "team-A-ban-5", desc: "힐러밴(선공)" },
  { id: "team-B-pick-5", desc: "힐러픽(후공)" },
  { id: "team-A-ban-5", desc: "힐러픽(선공)" }
];
